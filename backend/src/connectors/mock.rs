...
mod tests {
    ...
    async fn mock_returns_its_txns() {
        let c = MockConnector { txns: vec![ ExternalTxn { external_id:"x1".into(), occurred_at:"2026-01-01T00:00:00Z".into(), kind:"deposit".into(), symbol:"ETH".into(), quantity:"1".into(), fee:None, currency:"ETH".into(), price_native:None } ] };
